...
namespace Thermostat_Tests.HvacAlgorithms
{
    ...
    public class HeatOnlyTest
    {
        ...
        [DataRow( 85,      99,     86,   55,  true  , DisplayName = "Temp 1 - cool a little high")]
        [DataRow( 85,      99,     99,   55,  true  , DisplayName = "Temp 1 - cool a lot high")]
        ...
        [DataRow( 65,      65,     67,   55,  true  , DisplayName = "Temp 2 - cool a little high")]
        [DataRow( 65,      65,     99,   55,  true  , DisplayName = "Temp 2 - cool a lot high")]
        [DataRow( 55,      50,     99,   30,  true  , DisplayName = "Temp 3 - heat set way low")]
        [DataRow( 55,      50,     99,   54,  true  , DisplayName = "Temp 3 - heat set a little low")]
        [DataRow( 55,      50,     55,   55,  false , DisplayName = "Temp 3 - heat set on temp")]
        ...
        public void GetNewSystemState(double indoorTemp, double outdoorTemp, double maxTemp, double minTemp, bool heat)
        {
            ...
            HvacSensors sensors = new HvacSensors(indoorTemp: indoorTemp, outdoorTemp: outdoorTemp);
